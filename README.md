...
> **CS224G Project** — Luis Botin (lmbotin@stanford.edu) & Jesus Santos (jsaranda@stanford.edu)

AI-native insurance platform for operational/ AI liability claims.

---

## IMPORTANT — current demo status

The easiest way to see the demo today is through the live deployment:
...
3. Once inside the dashboard you will see:
